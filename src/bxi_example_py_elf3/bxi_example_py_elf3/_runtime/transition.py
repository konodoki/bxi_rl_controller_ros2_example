...
from bxi_example_py_elf3.mod_api.transition import TransitionPlan, TransitionPlugin
...
def _ensure_builtin_plugins() -> None:
    ...
    if _builtins_registered:
        return
    from bxi_example_py_elf3.transitions import BUILTIN_TRANSITION_PLUGINS
